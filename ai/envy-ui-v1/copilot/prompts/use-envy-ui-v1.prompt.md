...
- check block modifiers before using utilities to restyle a component's intrinsic appearance
- verify that any suggested `uiA` literal actually exists in the precompiled vocabulary
- avoid overlapping utility fragments that would set the same property twice
